...
import {Image,CloseButton} from '@chakra-ui/react'

const Header = ({toggleMenu , isOpen}) => {
    return (
       <header className="site-header">
               <Link href="/">
                    <a className="logo" ><Image maxWidth="60px" objectFit="cover" boxSize="40px" src="images/logo_transparent.png" alt="logo" /></a>
               </Link>
               ...
               <ul  className={`nav-list ${isOpen && 'active'}`}>
                    <Link  href="/restaurants"><a className="nav-item" >restauration</a></Link>
