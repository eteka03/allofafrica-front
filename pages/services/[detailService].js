...
const Detail = () => {
  ...
  const { detailService } = router.query;
            ...
            <Stack mt="20px" direction="row">
              <Box>
                ...
                <Stack>
                  ...
                  <Tag colorScheme="none">
                    <TagLeftIcon as={MdRestaurantMenu} fontSize="20px" />

                    <TagLabel>Restaurant</TagLabel>
                  </Tag>

                  <Tag>
                    <TagLeftIcon as={FaParking} fontSize="20px" />
                    <TagLabel>Parking</TagLabel>
                  </Tag>

                  <Tag>
                    <TagLeftIcon as={FaAccessibleIcon} fontSize="20px" />
                    <TagLabel>Accomodité</TagLabel>
                  </Tag>
                  <Tag>
                    <TagLeftIcon as={FaWifi} mr={10} fontSize="20px" />

                    <TagLabel>Wifi</TagLabel>
                  </Tag>
                  <Tag>
                    <TagLeftIcon as={MdSmokingRooms} mr={10} fontSize="20px" />
                    <TagLabel>Chambre fumeur</TagLabel>
                  </Tag>
                  <Tag>
                    <TagLeftIcon as={MdFreeBreakfast} mr={10} fontSize="20px" />
                    <TagLabel>Petit-déjeuner</TagLabel>
                  </Tag>
                  <Tag>
                    <TagLeftIcon as={MdLocalBar} mr={10} fontSize="20px" />
